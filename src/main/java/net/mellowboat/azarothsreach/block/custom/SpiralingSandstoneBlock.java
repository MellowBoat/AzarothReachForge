...
public class SpiralingSandstoneBlock extends SnowyDirtBlock {
    public SpiralingSandstoneBlock(Properties pProperties) {
        super(pProperties);
    }
    ...
    public static boolean isSnowySetting(BlockState pState) {
        return pState.is(ModBlocks.SPIRALING_SAND.get());
    }
}
